...
public abstract class AbstractMediaResource {
    ...
    protected Response getMediaFile(String filePath, String mediaType) {
        ...
        InputStream inputStream = getFileFromStorage(normalizedPath);

        log.infof("Stream retrieved: %s", inputStream != null ? "YES" : "NULL");
        ...
        return Response.ok(inputStream, contentType).build();
    }
    ...
    protected abstract InputStream getFileFromStorage(String filePath);
